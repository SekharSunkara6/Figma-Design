            ...
            <div className="flex flex-col items-center justify-start w-full pb-[22px]">
              <div className="flex flex-col items-start justify-start w-full">
                ...
                <div className="h-[632px] w-[69%] mt-[9px] relative">
                  ...
                  <div className="flex flex-row justify-start w-full right-0 top-[3%] m-auto absolute">
                  ...
                  <div className="flex flex-col items-start justify-center w-max h-max left-0 bottom-0 right-0 top-0 m-auto absolute">
                    ...
                    <div className="flex flex-row justify-start items-center w-[64%] mt-[22px] gap-px">
                ...
                <div className="h-[556px] w-[72%] mt-5 relative">
                  <div className="justify-center h-[556px] w-[97%] left-0 bottom-0 right-0 top-0 m-auto absolute">
                    ...
                    <div className="flex flex-row justify-start w-full right-0 top-[4%] m-auto absolute">
